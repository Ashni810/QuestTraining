...
namespace CreditCardSystem
{
    ...
    {
        public static List<CreditCard> CredictCards = new List<CreditCard>();
        ...
        static void AddCard()
        {
            ...
            Console.WriteLine($"Card {cardNumber} of {CardHolderName} has been added successfully");
        }
        ...
        static void UpdateCard()
        {
            ...
            foreach (var card in CredictCards)
            {
            ...
            if (cardToUpdate != null)
            {
                ...
                if (choice == "1")
                {
                    ...
                    cardToUpdate.CardHolderName = newName;
                    Console.WriteLine($"The card CardHolderName name for card {cardNumber} updated.");
                }
                else if (choice == "2")
                {
                    Console.WriteLine("Enter the new Cvc: ");
                    var newCvc = Console.ReadLine();
                    cardToUpdate.CardHolderName = newCvc;
                    Console.WriteLine($"The Cvc for card {cardNumber} updated.");
                }
            }
            else
            {
        ...
        static void DeleteCard()
        {
            ...
            {
                CredictCards.Remove(cardToDelete);
